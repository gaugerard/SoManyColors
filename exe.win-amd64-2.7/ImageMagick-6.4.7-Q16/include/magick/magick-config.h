...
// function which automatically invokes MagickToolkitGenesis(NULL), and
// MagickToolkitTerminus() so that the user doesn't need to. This is enabled
// by default.
//
...
//
//#under MAGICKCORE_EXCLUDE_DEPRECATED
...
#define MAGICKCORE_WMFLITE_DELEGATE
